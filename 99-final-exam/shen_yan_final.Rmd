...
tbl <- data.frame(x = seq(0, 10, by = 0.01))

tbl$p <- epdfstar(tbl$x, adult_scr, density(adult_scr)$bw)
...
```{r}
plot(ecdf(Y), xlab = "creatinine", ylab = "density", main = "Kernel Density Estimation")
```
